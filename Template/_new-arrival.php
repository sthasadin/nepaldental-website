...
<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    if(!isset($_POST['new-arrival-submit'])){
            ...
            <div class="item py-1 px-2">
              <div class="product font-rale">
                ...
                <div class="text-center">
                  ...
                  <button type="submit" name="new-arrival-submit" class="btn btn-warning font-size-12">Add to Cart</button>
